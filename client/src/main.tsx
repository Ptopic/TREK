...
// the standard drag events from touch gestures over explicit draggable handles. Regular
// map and list gestures remain native; see utils/touchDragPolyfill.ts.
